...
| Unciv | 2,084 | 12 | 2 | While a turn resolves: 1,775 fps, 1st of 2 | Peak memory: 1.26 GiB, 4th of 4 |
| Freeciv | 1,741 (provisional) | 3 | 10 | Turn delivery time: 0.0001 s, 1st of 2 | Slowest turn: 4.072 s, 4th of 4 |
| Greater Diplomacy 5 | 893 | 1 | 18 | Late-game slowdown: 0.81x, 1st of 4 | Turn delivery time: 0.0839 s, 2nd of 2 |
...
|---|---|---|---|---|
| Turns per minute | more | Open Doctrines, 2,373 turns/min | Freeciv, 52.36 turns/min | 45.3x more |
| Player-turns per minute | more | Open Doctrines, 87,795 player-turns/min | Freeciv, 1,832 player-turns/min | 47.9x more |
| Region-turns per minute | more | Open Doctrines, 2,149,791 region-turns/min | Greater Diplomacy 5, 67,022 region-turns/min | 32.1x more |
| Turns per minute, slowest run | more | Open Doctrines, 2,339 turns/min | Freeciv, 52.13 turns/min | 44.9x more |
| Median turn | less | Open Doctrines, 0.0254 s | Freeciv, 1.124 s | 44.3x less |
| Slow turn (95th percentile) | less | Open Doctrines, 0.0289 s | Freeciv, 2.219 s | 76.8x less |
| Slowest turn | less | Open Doctrines, 0.0330 s | Freeciv, 4.072 s | 123.4x less |
| Late-game slowdown | less | Greater Diplomacy 5, 0.81x | Freeciv, 2.17x | 2.7x less |
| Start-up | less | Open Doctrines, 0.188 s | Greater Diplomacy 5, 1.196 s | 6.4x less |
| Peak memory | less | Freeciv, 69.6 MiB | Unciv, 1.26 GiB | 18.6x less |
| Memory per player | less | Freeciv, 1.99 MiB | Unciv, 36.9 MiB | 18.6x less |
| CPU time per turn | less | Open Doctrines, 0.0252 s | Freeciv, 1.141 s | 45.3x less |
| CPU time per player-turn | less | Open Doctrines, 0.0007 s | Freeciv, 0.0326 s | 47.9x less |
...
- **Open Doctrines**: went best at Data per turn, lowest: 2.45 KiB, 1st of 4; CPU time per player-turn: 0.0007 s, 1st of 4; CPU time per turn: 0.0252 s, 1st of 4. Went worst at nothing (no last places).
- **Unciv**: went best at While a turn resolves: 1,775 fps, 1st of 2; Map, late game: 1,548 fps, 1st of 3; Map, start of game: 1,389 fps, 1st of 3. Went worst at Peak memory: 1.26 GiB, 4th of 4; Memory per player: 36.9 MiB, 4th of 4.
- **Freeciv**: went best at Turn delivery time: 0.0001 s, 1st of 2; Peak memory: 69.6 MiB, 1st of 4; Memory per player: 1.99 MiB, 1st of 4. Went worst at Slowest turn: 4.072 s, 4th of 4; Highest data per turn per player: 6.42 KiB, 2nd of 2; Slow turn (95th percentile): 2.219 s, 4th of 4.
- **Greater Diplomacy 5**: went best at Late-game slowdown: 0.81x, 1st of 4. Went worst at Turn delivery time: 0.0839 s, 2nd of 2; Data per turn, highest: 17.9 MiB, 4th of 4; Data per turn, median: 11.5 MiB, 4th of 4.
...
| Greater Diplomacy 5 | 73.98 turns/min (3rd) | 2,589 player-turns/min (3rd) | 67,022 region-turns/min (4th) | 73.77 turns/min (3rd) | 0.728 s (3rd) | 1.308 s (3rd) | 1.545 s (3rd) | 0.81x (1st) | 1.196 s (4th) | 35 | 906 |
| Freeciv | 52.36 turns/min (4th) | 1,832 player-turns/min (4th) | 151,203 region-turns/min (3rd) | 52.13 turns/min (4th) | 1.124 s (4th) | 2.219 s (4th) | 4.072 s (4th) | 2.17x (4th) | 0.628 s (2nd) | 35 | 2,888 |
...
- **Game size**: Player counts differ (35 to 37), and so do map sizes. The player-turn and region-turn figures account for size, not for rules or how much thinking each AI does.
...
| Unciv | 1.26 GiB (4th) | 36.9 MiB (4th) | 0.418 s (2nd) | 0.0120 s (2nd) | 1.69 cores |
