...
**1,741 points**, OJH score version 2, provisional

![OJH score 1,741](score-freeciv.svg)
...
|---|---|---|---|---|---|---|
| Turn throughput | ojh tpm | 22% | 1,832 player-turns/min | 1,065 player-turns/min | 2,000 player-turns/min | 616 |
| World throughput | ojh tpm | 13% | 151,203 region-turns/min | 87,893 region-turns/min | 200,000 region-turns/min | 526 |
| Late-game pace | ojh tpm | 8% | 0.46 | same | 0.50 | 943 |
| Steadiness | ojh tpm | 5% | 0.51 | same | 0.50 | 1,010 |
| Start-up | ojh tpm | 5% | 0.628 s | 1.080 s | 10.0 s | 3,358 |
| CPU per player-turn | ojh tpm | 6% | 0.0326 s | 0.0561 s | 0.0100 s | 237 |
| Memory | ojh tpm | 8% | 69.6 MiB | same | 2.00 GiB | 4,927 |
| Frame rate | ojh fps | 12% | not measured | n/a | 60 fps | n/a |
| Smoothness | ojh fps | 8% | not measured | n/a | 30 fps | n/a |
| Data per turn | ojh net | 9% | 225 KiB | same | 256 KiB | 1,098 |
| Turn delivery | ojh net | 4% | 0.0001 s | 0.0001 s | 0.100 s | 9,699 |
...
- **Network**: freeciv-server with 35 AI players and 2 freeciv-gtk4 clients on this machine, each attached as a global observer, every byte through OJH's loopback relay; a turn ends at the server's End/start-turn log line
- **Turn speed settings**: 250 turns asked for, 249 timed, seed 20260914, 35 players chosen by OJH
- **Machine**: Apple M1 Pro, macOS 26.3 (25D125)
- **CPU reference score**: 1,720 rounds/s on one core; CPU-bound figures were put on OJH's reference CPU (1,000 rounds/s) with a factor of 0.581
