...
**679 points**, OJH score version 2

![OJH score 679](score-freecol.svg)
...
|---|---|---|---|---|---|---|
| Turn throughput | ojh tpm | 22% | 778.8 player-turns/min | 450.2 player-turns/min | 2,000 player-turns/min | 293 |
| World throughput | ojh tpm | 13% | 194,707 region-turns/min | 112,547 region-turns/min | 200,000 region-turns/min | 644 |
| Late-game pace | ojh tpm | 8% | 0.08 | same | 0.50 | 203 |
| Steadiness | ojh tpm | 5% | 0.26 | same | 0.50 | 603 |
| Start-up | ojh tpm | 5% | 0.981 s | 1.697 s | 10.0 s | 2,785 |
| CPU per player-turn | ojh tpm | 6% | 0.0868 s | 0.150 s | 0.0100 s | 93 |
| Memory | ojh tpm | 8% | 1.16 GiB | same | 2.00 GiB | 1,443 |
...
- **CPU reference score**: 1,730 rounds/s on one core; CPU-bound figures were put on OJH's reference CPU (1,000 rounds/s) with a factor of 0.578
