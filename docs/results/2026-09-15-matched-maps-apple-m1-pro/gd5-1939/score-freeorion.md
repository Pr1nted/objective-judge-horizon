# FreeOrion (version 0.5.1.2): OJH score

**295 points**, OJH score version 2

![OJH score 295](score-freeorion.svg)
...
|---|---|---|---|---|---|---|
| Turn throughput | ojh tpm | 22% | 223 player-turns/min | 131.2 player-turns/min | 2,000 player-turns/min | 92 |
| World throughput | ojh tpm | 13% | 5,774 region-turns/min | 3,398 region-turns/min | 200,000 region-turns/min | 24 |
| Late-game pace | ojh tpm | 8% | 0.22 | same | 0.50 | 533 |
| Steadiness | ojh tpm | 5% | 0.49 | same | 0.50 | 992 |
| Start-up | ojh tpm | 5% | 8.284 s | 14.1 s | 10.0 s | 774 |
| CPU per player-turn | ojh tpm | 6% | 0.737 s | 1.252 s | 0.0100 s | 11 |
| Memory | ojh tpm | 8% | 4.44 GiB | same | 2.00 GiB | 537 |
...
- **Game**: FreeOrion (version 0.5.1.2), GPL-2.0, https://www.freeorion.org
- **Turn speed**: FreeOrion's own "OJH turn" lines, the gaps between them (250 turns timed of 250 turn lines)
...
- **CPU reference score**: 1,699 rounds/s on one core; CPU-bound figures were put on OJH's reference CPU (1,000 rounds/s) with a factor of 0.588
