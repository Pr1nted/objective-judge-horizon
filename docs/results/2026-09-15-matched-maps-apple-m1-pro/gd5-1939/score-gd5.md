...
**893 points**, OJH score version 2

![OJH score 893](score-gd5.svg)
...
|---|---|---|---|---|---|---|
| Turn throughput | ojh tpm | 22% | 2,589 player-turns/min | 1,517 player-turns/min | 2,000 player-turns/min | 814 |
| World throughput | ojh tpm | 13% | 67,022 region-turns/min | 39,270 region-turns/min | 200,000 region-turns/min | 259 |
| Late-game pace | ojh tpm | 8% | 1.24 | 1.00 (capped) | 0.50 | 1,585 |
| Steadiness | ojh tpm | 5% | 0.56 | same | 0.50 | 1,079 |
| Start-up | ojh tpm | 5% | 1.196 s | 2.041 s | 10.0 s | 2,560 |
| CPU per player-turn | ojh tpm | 6% | 0.0230 s | 0.0393 s | 0.0100 s | 327 |
| Memory | ojh tpm | 8% | 1.01 GiB | same | 2.00 GiB | 1,578 |
| Frame rate | ojh fps | 12% | 104.3 fps | same | 60 fps | 1,453 |
| Smoothness | ojh fps | 8% | 5.18 fps | same | 30 fps | 230 |
| Data per turn | ojh net | 9% | 17.9 MiB | same | 256 KiB | 20 |
| Turn delivery | ojh net | 4% | 0.0839 s | 0.143 s | 0.100 s | 764 |
...
- **Frame rate**: Greater Diplomacy 5's own map_tools/ojh_benchmark.py fps mode: the real game window brought to the front, no frame cap, every frame of each scene timed for 5.00 s after settling, on scenarios/historical/1939; pygame draws in software; the late-game map comes after 20 turns
...
- **CPU reference score**: 1,707 rounds/s on one core; CPU-bound figures were put on OJH's reference CPU (1,000 rounds/s) with a factor of 0.586
