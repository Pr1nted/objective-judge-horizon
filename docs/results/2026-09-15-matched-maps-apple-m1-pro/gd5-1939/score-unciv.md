...
**2,084 points**, OJH score version 2

![OJH score 2,084](score-unciv.svg)
...
|---|---|---|---|---|---|---|
| Turn throughput | ojh tpm | 22% | 10,508 player-turns/min | 6,087 player-turns/min | 2,000 player-turns/min | 2,016 |
| World throughput | ojh tpm | 13% | 378,593 region-turns/min | 219,309 region-turns/min | 200,000 region-turns/min | 1,068 |
| Late-game pace | ojh tpm | 8% | 0.63 | same | 0.50 | 1,174 |
| Steadiness | ojh tpm | 5% | 0.59 | same | 0.50 | 1,130 |
| Start-up | ojh tpm | 5% | 0.777 s | 1.341 s | 10.0 s | 3,080 |
| CPU per player-turn | ojh tpm | 6% | 0.0120 s | 0.0206 s | 0.0100 s | 570 |
| Memory | ojh tpm | 8% | 1.26 GiB | same | 2.00 GiB | 1,369 |
| Frame rate | ojh fps | 12% | 1,389 fps | same | 60 fps | 4,594 |
| Smoothness | ojh fps | 8% | 255.0 fps | same | 30 fps | 3,248 |
| Data per turn | ojh net | 9% | 107 KiB | same | 256 KiB | 1,762 |
...
- **Network**: Unciv has no live connection: its multiplayer uploads the whole game after a turn and the other player downloads it. OJH's Unciv driver plays 20 turns with 35 civilizations and reports the size of that compressed game after each one, counted once up and once down; no relay, so turn delivery is n/a
- **Turn speed settings**: 250 turns asked for, 250 timed, seed 20260914, 35 players chosen by OJH
- **Machine**: Apple M1 Pro, macOS 26.3 (25D125)
- **CPU reference score**: 1,726 rounds/s on one core; CPU-bound figures were put on OJH's reference CPU (1,000 rounds/s) with a factor of 0.579
