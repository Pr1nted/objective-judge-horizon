...
**1,598 points**, OJH score version 2, provisional

![OJH score 1,598](score-freeciv.svg)
...
|---|---|---|---|---|---|---|
| Turn throughput | ojh tpm | 22% | 1,755 player-turns/min | 1,019 player-turns/min | 2,000 player-turns/min | 594 |
| World throughput | ojh tpm | 13% | 107,845 region-turns/min | 62,628 region-turns/min | 200,000 region-turns/min | 393 |
| Late-game pace | ojh tpm | 8% | 0.45 | same | 0.50 | 928 |
| Steadiness | ojh tpm | 5% | 0.40 | same | 0.50 | 852 |
| Start-up | ojh tpm | 5% | 0.999 s | 1.720 s | 10.0 s | 2,768 |
| CPU per player-turn | ojh tpm | 6% | 0.0341 s | 0.0587 s | 0.0100 s | 227 |
| Memory | ojh tpm | 8% | 87.7 MiB | same | 2.00 GiB | 4,606 |
| Frame rate | ojh fps | 12% | not measured | n/a | 60 fps | n/a |
| Smoothness | ojh fps | 8% | not measured | n/a | 30 fps | n/a |
| Data per turn | ojh net | 9% | 517 KiB | same | 256 KiB | 580 |
| Turn delivery | ojh net | 4% | 0.0001 s | 0.0001 s | 0.100 s | 10,183 |
...
- **Network**: freeciv-server with 63 AI players and 2 freeciv-gtk4 clients on this machine, each attached as a global observer, every byte through OJH's loopback relay; a turn ends at the server's End/start-turn log line
- **Turn speed settings**: 250 turns asked for, 249 timed, seed 20260914, 63 players chosen by OJH
- **Machine**: Apple M1 Pro, macOS 26.3 (25D125)
- **CPU reference score**: 1,722 rounds/s on one core; CPU-bound figures were put on OJH's reference CPU (1,000 rounds/s) with a factor of 0.581
