...
**2,656 points**, OJH score version 2

![OJH score 2,656](score-opendoctrines.svg)
...
|---|---|---|---|---|---|---|
| Turn throughput | ojh tpm | 22% | 38,761 player-turns/min | 22,453 player-turns/min | 2,000 player-turns/min | 3,612 |
| World throughput | ojh tpm | 13% | 798,593 region-turns/min | 462,604 region-turns/min | 200,000 region-turns/min | 1,728 |
| Late-game pace | ojh tpm | 8% | 0.86 | same | 0.50 | 1,439 |
| Steadiness | ojh tpm | 5% | 0.81 | same | 0.50 | 1,387 |
| Start-up | ojh tpm | 5% | 1.034 s | 1.785 s | 10.0 s | 2,723 |
| CPU per player-turn | ojh tpm | 6% | 0.0015 s | 0.0027 s | 0.0100 s | 2,248 |
| Memory | ojh tpm | 8% | 559 MiB | same | 2.00 GiB | 2,222 |
| Frame rate | ojh fps | 12% | 620.9 fps | same | 60 fps | 3,504 |
| Smoothness | ojh fps | 8% | 150.3 fps | same | 30 fps | 2,588 |
| Data per turn | ojh net | 9% | 36.6 KiB | same | 256 KiB | 2,999 |
...
- **Frame rate**: Open Doctrines' own --ojh-fps mode: its real window with vsync and the frame cap off, every frame timed for 5.00 s per scene after two seconds of settling, on the <open-doctrines>/data/STDmaps/1939.odmap world; the late-game map comes after 20 turns
