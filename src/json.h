...
/* A streaming JSON writer: values go straight to a FILE, indented, with commas placed
   for you. Nesting deeper than OJH_JSON_MAX_DEPTH stops the writer. */
...
void ojh_json_end(ojh_json *w, char closer); /* '}' or ']' */
...
void ojh_json_double(ojh_json *w, double v, int decimals); /* NaN and infinity become null */
